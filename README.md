...
Design-first; code lands incrementally. Full specs: [`unwritten-engine-design-specification.md`](specs/unwritten-engine-design-specification.md) (engine, v1.1) · [`unwritten-lab-experiments-repo-spec.md`](specs/unwritten-lab-experiments-repo-spec.md) (lab, v0.4).
