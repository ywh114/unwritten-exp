...
| `biosphere-addendum-b3-substrate-ground.md` v0.1 | proposal | amends flora RFC §2: substrate (`ground`) derivation pass — 41 classes with float property rows, physical + biome-bias engines, full d2 vector persisted (supersedes B2's top-2 note for substrate), underwater integrated; research basis `specs/b3_substrate_research_report.md` | pending owner review |
